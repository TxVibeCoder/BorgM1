...
rem
rem NOTE: this file MUST keep CRLF line endings. cmd.exe misparses an LF-only
rem batch file and drops the first characters of every line. .gitattributes
rem pins it so a clone on any platform still gets CRLF.
cd /d "%~dp0"
